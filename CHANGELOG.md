...
- Ship and launch-vehicle lists in a body's info window render as square icon tiles matching the facility and module tiles instead of full-width rows, keeping drag and drop, click-for-details, the build-progress shade and a per-ship cancel X. `Object Info / ShipTilesEnabled`, on by default.
